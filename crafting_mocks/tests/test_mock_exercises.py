...
#     # the argument "Steve"
#     assert fake_object.speak.called  # Checks assert was called at all
#     fake_object.speak.assert_called_with("Steve") # Checks assert was called with "Steve" or throws assertion error
...
#     fake_diary = Mock()
#     fake_diary.count_entries = lambda: fake_diary.add.call_count
